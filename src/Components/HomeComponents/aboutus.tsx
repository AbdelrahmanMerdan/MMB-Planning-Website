    ...
    return(
        <div className="AboutContainer">
            ...
            <div className="AboutRight">
                ...
                quality construction. Make your property dreams come true – reach out to us today and let 
                us be your trusted partner in planning your next project with confidence.
                <br />
                <br />
